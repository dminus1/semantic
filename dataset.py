...
#@register(segment=['train_root', 'dev_root', 'test_root']) #ROOT 
...
class MRPCDataset(TSVDataset):
    ...
    """
    #def __init__(self, segment='train_root', #
    def __init__(self, segment='train',
                 root=os.path.join(os.getenv('GLUE_DIR', 'glue_data'), 'MRPC')):
        #self._supported_segments = ['train_root', 'dev_root', 'test_root'] #
    ...
    def get_labels():
        ...
        return ['0', '1', '2', '3', '4', '5', '6'] # for Evalution
        #return ['0', '1', '2', '3', '4', '5'] #worked with bless and root #
        #return ['0', '1']
